...
pub fn SocialLinks() -> Element {
    rsx! {
        ul {
            ...
            SocialIcon { href: "https://www.linkedin.com/in/opensass", icon: ""},
            SocialIcon { href: "https://www.x.com/opensassorg", icon: ""},
            SocialIcon { href: "https://www.github.com/opensass", icon: ""}
        }
    }
}
